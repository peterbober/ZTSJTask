#
#  Be sure to run `pod spec lint ZTSJTask.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/peterbober/ZTSJTask.git", :commit => "449cfa6a5b8f20628bb1e38ccc72b70761686caf" }
